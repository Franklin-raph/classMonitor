...
const {
  ...
  getAssessmentDetail,
} = require("../../controllers/studentAndAdminAssessmentController");
...
// student or admin getting the detail of a single assessment
router.get("/getAssessmentDetail/:taskId", getAssessmentDetail);
